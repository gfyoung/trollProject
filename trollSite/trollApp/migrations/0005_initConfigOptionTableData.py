...
def populateConfigOptionTable(apps, schema_editor):
    ...
    trollRedirectProb = ConfigOption.objects.create(
        name="trollRedirectProb", value=0.1)
    updateFrequency = ConfigOption.objects.create(
        name="updateFrequency", value=0.05)
